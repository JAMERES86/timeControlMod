package net.time.stop;

import com.mojang.logging.LogUtils;
import net.time.stop.block.ModBlocks;
import net.time.stop.block.entity.ModBlockEntities;
import net.time.stop.entity.ModEntityTypes;
import net.time.stop.entity.client.ChomperRenderer;
import net.time.stop.fluid.ModFluidTypes;
import net.time.stop.fluid.ModFluids;
import net.time.stop.item.ModCreativeModeTab;
import net.time.stop.item.ModItems;
import net.time.stop.loot.ModLootModifiers;
import net.time.stop.networking.ModMessages;
import net.time.stop.painting.ModPaintings;
import net.time.stop.recipe.ModRecipes;
import net.time.stop.screen.GemInfusingStationScreen;
import net.time.stop.screen.ModMenuTypes;
import net.time.stop.villager.ModVillagers;
...
public class TutorialMod {
    ...
    private void addCreative(CreativeModeTabEvent.BuildContents event) {
        if(event.getTab() == ModCreativeModeTab.TUTORIAL_TAB) {
            event.registerSimple(ModCreativeModeTab.TUTORIAL_TAB,ModItems.ZIRCON.get());
