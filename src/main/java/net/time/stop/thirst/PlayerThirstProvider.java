...
public class PlayerThirstProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
    ...
    private final LazyOptional<PlayerThirst> optional = LazyOptional.of(this::createOrUsePlayerThirst);

    private PlayerThirst createOrUsePlayerThirst() {
        if(this.thirst == null) {
    ...
    public CompoundTag serializeNBT() {
        ...
        createOrUsePlayerThirst().saveNBTData(nbt);
        return nbt;
    }

    @Override
    public void deserializeNBT(CompoundTag nbt) {
        createOrUsePlayerThirst().loadNBTData(nbt);
    }
}
